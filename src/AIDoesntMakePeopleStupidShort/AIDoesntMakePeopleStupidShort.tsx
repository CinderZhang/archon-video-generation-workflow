...
export const AIDoesntMakePeopleStupidShort: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg }}>
      {/* Scene 1 — hook + MIT EEG distinction (stacked top/bottom) */}
      <Sequence
        from={s1From}
      ...
      {/* Scene 2 — harness-and-horse + Bastani / Kestin stat cards (stacked) */}
      <Sequence
        from={s2From}
...
export default AIDoesntMakePeopleStupidShort;

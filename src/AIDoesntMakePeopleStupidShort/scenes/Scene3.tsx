...
// =====================================================================
// DRIVER wordmark — full-width letters, final R gets the green sweep.
// =====================================================================
...
const BrandLine: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        Field-tested with 300+ students
        <br />
        Purdue
      </div>
    </div>
...
// =====================================================================
// Proof beat — "Top 5 students. Production apps. Public repos."
// =====================================================================
...
const CTA: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span>Watch my top 5 prove it</span>
...
const SourcesRail: React.FC = () => {
  ...
  return (
    ...
    >
      <div>Bastani · PNAS 2025</div>
      <div>Kestin · Harvard 2025</div>
    </div>
  );
};

...
// blend over this overlap. Hand-rolled because TransitionSeries is not
...
export const WhatIsDriver: React.FC = () => {
  const { fps } = useVideoConfig();
  // Premount the next scene so it is fully buffered before its window begins;
  // avoids first-frame jank for audio start.
  const premount = fps;
